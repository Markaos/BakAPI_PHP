...
<head>
  <meta charset="utf-8" />
  <title>Přihlášení | BakAPI</title>
</head>
<body>
  <p>
<?php
if($res["result"] == BAKAPI_ERROR_SERVER_UNSUPPORTED)
    echo "Nelze se připojit k serveru";
else
...
?>
  ...
  <form method="POST">
    ...
    <input type="url" name="server" placeholder="Server" /><br>
    <input type="hidden" name="keepAccount" value="false" /><br>
